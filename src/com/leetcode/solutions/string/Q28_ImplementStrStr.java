...
public class Q28_ImplementStrStr implements SolutionInterface {
    interface Algorithm {
    ...
    static class KMP implements Algorithm {
        /***
         * 公共字符串匹配问题，KMP算法。
         ...
         *
         * KMP算法优化：
         * 以下是KMP算法的全部代码，实际上代码可以变得更加简洁高效，具体来说就是：
    ...
    static class Sunday implements Algorithm {
        /***
         * Sunday算法，直接参考下边这篇文章即可，相当容易理解。
